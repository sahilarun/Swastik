...
export const DEFAULT_CONFIG: Omit<SwastikConfig, 'theme'> = {
  staticImage: true,
  flexsearch: {
    codeblocks: true
  },
...
export const OFFICIAL_THEMES = ['swastik-theme-docs', 'swastik-theme-blog']
...
export const SWASTIK_INTERNAL = Symbol.for('__swastik_internal__')
