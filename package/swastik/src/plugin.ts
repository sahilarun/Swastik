      ...
      try {
        ...
        if (fileName === DYNAMIC_META_FILENAME) {
          ...
          if (typeof meta === 'function') {
            // Dynamic. Add a special key (__swastik_src) and set data as empty.
            fileMap[fp] = {
              kind: 'Meta',
              ...(locale && { locale }),
              __swastik_src: filePath,
              data: {}
            }
            ...
            console.error(
              `[swastik] "${fileName}" वैधमेटासञ्चिका नास्ति । पूर्वनिर्धारितं निर्यातं क्रमाङ्कनीयं वस्तु अथवा कार्यं भवितुम् आवश्यकम् । कृपया निम्नलिखितसञ्चिकां पश्यन्तु ।`,
        ...
        console.error(
          `[swastik] ${relPath} लोड् करणं त्रुटिः।
${(err as Error).name}: ${(err as Error).message}`
      ...
      if (fileName === 'meta.json') {
        console.warn(
          '[swastik] "meta.json" इत्यस्य नाम "_meta.json" इति परिवर्तितम् । निम्नलिखितसञ्चिकायाः ​​नाम परिवर्तनं कुर्वन्तु ।',
          path.relative(CWD, filePath)
        )
      } else if (/_meta\.(jsx|ts|tsx|cjs|mjs)$/.test(fileName)) {
        console.error(
          `[swastik] "${fileName}" सम्प्रति समर्थितं नास्ति, कृपया निम्नलिखितसञ्चिकायाः ​​नाम "${DYNAMIC_META_FILENAME}" इति परिवर्तयन्तु:`,
          path.relative(CWD, filePath)
        )
      }
    })
