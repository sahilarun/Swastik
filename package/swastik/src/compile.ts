...
globalThis.__swastik_temp_do_not_use = () => {
  import('./__temp__')
}
...
export async function compileMdx(
  ...
  try {
    ...
    console.error(`[swastik] ${filePath} संकलने त्रुटिः।`)
    throw err
  }
  ...
  function createCompiler(): Processor {
    return createProcessor({
      ...
      providerImportSource: isFileOutsideCWD
        ? require.resolve('swastik').replace(/index\.js$/, 'mdx.js') // fixes Package subpath './mdx' is not defined by "exports"
        : 'swastik/mdx',
      remarkPlugins: [
        ...(remarkPlugins || []),
        ...
        [
          ...
          {
            packageName: 'swastik/components',
            tabNamesProp: 'items',
