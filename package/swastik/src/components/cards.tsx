...
const classes = {
  cards: cn(
    'swastik-cards nx-mt-4 nx-gap-4 nx-grid',
    'nx-not-prose'
  ),
  card: cn(
    'swastik-card nx-group nx-flex nx-flex-col nx-justify-start nx-overflow-hidden nx-rounded-lg nx-border nx-border-gray-200',
