...
export const Pre = ({
  ...
  const toggleWordWrap = useCallback(() => {
    ...
    const hasWordWrap = 'swastikWordWrap' in htmlDataset
    if (hasWordWrap) {
      delete htmlDataset.swastikWordWrap
    } else {
      htmlDataset.swastikWordWrap = ''
    }
  }, [])

  return (
    <div className="swastik-code-block nx-relative nx-mt-6 first:nx-mt-0">
      {filename && (
