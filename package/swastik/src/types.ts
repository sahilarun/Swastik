...
export interface LoaderOptions extends SwastikConfig {
...
export type Swastik = (
  ...args: [SwastikConfig] | [theme: Theme, themeConfig: string]
) => (nextConfig: NextConfig) => NextConfig

const swastik: Swastik = () => () => ({})

export default swastik

export type ThemeConfig = any | null

export type SwastikThemeLayoutProps = {
  pageOpts: PageOpts
  pageProps: any
...
export type SwastikInternalGlobal = typeof globalThis & {
  [SWASTIK_INTERNAL]: {
    pageMap: PageMapItem[]
    route: string
    context: Record<
